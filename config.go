...
import (
	...
	"github.com/pandazwb/btcd/connmgr"
...
type config struct {
	...
	Listeners            []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 3888, testnet: 13888)"`
	...
	RPCListeners         []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 3889, testnet: 13889)"`
